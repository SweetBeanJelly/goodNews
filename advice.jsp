...
<html>
 ...
 <body>
	...
	<!-- 본문 -->
		...
		<img src="./images/advice.png" width="250px" alt="상담하기"/>
		...
		<table class="Table">
			...
			<colgroup>
				...
				<tr>
					<th><img src="./images/writing/inquiry.png" width="55px" /></th>
					<td>
						<select title="문의파트" id="category" name="category" style="min-width:100px"> 
		...
		<input type="image" src="./images/back2.png" style="width:30px;height:30px;margin-right:30px;" alt="뒤로가기" />
		</p>
