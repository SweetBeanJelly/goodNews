...
<html>
 ...
 <body>
	...
	<!-- 본문 -->
		...
		<div>
			<form id="join" method="post" action="signup.jsp">
				<img src="./images/join.png" width="250px" alt="가입하기"/>
				<p>
				<img src="./images/joinsub.png" width="250px" alt="가입설명"/>
					<table>
					  <tr>
					  ...
					  <tr>
						...
						<td class="input"><input type="text" name="id" required /></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<input class="btn" type="image" src="./images/ok.png" width="30px" height="30px" onclick='return chk()' />
